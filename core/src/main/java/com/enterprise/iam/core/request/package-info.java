 ...
 */
@ApplicationModule(displayName = "Request", allowedDependencies = {"shared::*", "audit::api", "identity::api", "account::api", "target::api", "policy::api", "risk::api", "sod::api", "authorization::api", "operation::api"})
